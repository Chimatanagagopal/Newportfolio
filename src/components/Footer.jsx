    ...
    <footer className="relative py-10 border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
        <div className="font-display font-bold text-lg">
          ...
          <span className="text-white/20 text-sm font-body font-normal ml-2">/ {personalInfo.shortName}</span>
        </div>

        <p className="text-white/20 text-xs font-mono text-center">
          Built with React + Vite + Tailwind + Three.js &nbsp;·&nbsp; © 2024 {personalInfo.shortName}
        </p>

        <div className="flex items-center gap-4">
          <a href={personalInfo.github} target="_blank" rel="noreferrer" className="text-white/25 hover:text-[#00f5d4] transition-colors duration-300">
          ...
          <a href={personalInfo.linkedin} target="_blank" rel="noreferrer" className="text-white/25 hover:text-[#00f5d4] transition-colors duration-300">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
